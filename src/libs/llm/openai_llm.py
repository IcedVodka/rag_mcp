#!/usr/bin/env python3
"""
OpenAI LLM - OpenAI-Compatible API Implementation

Supports OpenAI, Groq, and other OpenAI-compatible endpoints.
"""
...
class OpenAILLM(BaseLLM):
    ...
    def chat(
        ...
        response_data = self._make_request(openai_messages, temperature, max_tokens)
